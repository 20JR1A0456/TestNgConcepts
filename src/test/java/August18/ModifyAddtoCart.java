...
public class ModifyAddtoCart {
	@Test(groups = {"Regression"}) // making groups 
	//@Test(enabled = false) // skiping test case by setting enabled = false
	public void mobile() throws InterruptedException {
		...
		country.sendKeys("Dark world");
		Thread.sleep(3000);
		WebElement city = driver.findElement(By.xpath("//input[@id='city']"));
		city.sendKeys("Dark Knight");
		Thread.sleep(2000);
		WebElement creditcard = driver.findElement(By.xpath("//input[@id='card']"));
		creditcard.sendKeys("4581 4455 5487");
		Thread.sleep(2000);
