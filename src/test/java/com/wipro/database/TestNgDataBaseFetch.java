...
import utilities.LoggrHelper;

public class TestNgDataBaseFetch {
	private static final org.apache.logging.log4j.Logger log = LoggrHelper.getLogger(TestNgDataBaseFetch.class);
	@Test
	...
	// fetch the db url , password and username of the my sql db 
		...
		while (rs.next()) {
			...
			String paswd = rs.getString("position");
